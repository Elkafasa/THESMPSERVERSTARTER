...
> **Note:** No prior experience with GitHub is required to use this

**⏱️ Setup Time:** 5-10 minutes

## ⚠️ Before You Start
> [!WARNING]
> I **highly** recommend to create a **2nd seedloaf account** with a role that can only **start** the server (check out the roles in seedloaf). This is incase someone gets hold of your github account, all they can do it start server.
...
> [!WARNING]
> Do NOT give any other permissions except the mentioned ones! This would let the anyone with token edit your fork. So check if these are the final permissions

![PAT1](https://github.com/dibope/mcserverstarter/blob/main/.github/workflows/Images/PAT1.jpg)
![PAT2](https://github.com/dibope/mcserverstarter/blob/main/.github/workflows/Images/PAT2.jpg)
